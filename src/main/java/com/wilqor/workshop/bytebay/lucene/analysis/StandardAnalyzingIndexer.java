...
public class StandardAnalyzingIndexer implements Indexer<CommentedReview> {
    private static final Logger LOGGER = LogManager.getLogger(StandardAnalyzingIndexer.class);
    ...
    StandardAnalyzingIndexer(Path targetDirectory) throws IOException {
